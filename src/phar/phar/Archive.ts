...
export default class Archive {
     ...
     * @type {number}
     */
    private signatureType: number = 0
    ...
    savePharData(asU8A: boolean = true): string | Uint8Array {
        ...
        buffer.putString(manifestBuffer.getBuffer()).put(allContents)
        ...
        buffer.put(hash).putLInt(this.signatureType).put(PharConst.END_MAGIC)
